...
public class WhiteboardPeer {
	...
	public static void trasmitBoardData(String boardData,Endpoint endpoint)
	{
		endpoint.emit(boardData, boardData);
	}
	 ...
	 * @param endpoint
	 */
	public static void emitIndexUpdate(String peerport,String boardId,Endpoint endpoint,
			ClientManager clientManager) {
			endpoint.emit(WhiteboardServer.shareBoard, peerport+":"+boardId);
	}
	...
	public static void main(String[] args) {
		...
		//Arpan have to commit the following line
